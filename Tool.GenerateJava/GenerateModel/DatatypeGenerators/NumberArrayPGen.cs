...
{
    internal class NumberArrayPGen : IDatatypeGenerator
    {
        ...
        {
            yield return
                DtGenUtil.GenNativeGetMethod(_prop, "JsArrayNumber", false, string.Format("get{0}Raw", _prop.Name));
        ...
        {
            yield return
                string.Format("\tpublic final ListProperty<Double> {0} = listProperty(\"{0}\");",
