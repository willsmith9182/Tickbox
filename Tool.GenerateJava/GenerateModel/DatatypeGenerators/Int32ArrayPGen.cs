...
{
    class Int32ArrayPGen : IDatatypeGenerator
    {
        ...
        {
            yield return string.Format("\tpublic final ListProperty<Integer> {0} = listProperty(\"{0}\");", DtGenUtil.ToJavaMemberName(_prop.Name));
        }
