...
{
    internal class StringArrayPGen : IDatatypeGenerator
    {
        ...
        {
            yield return
                DtGenUtil.GenNativeGetMethod(_prop, "JsArrayString", false, string.Format("get{0}Raw", _prop.Name));
        ...
        {
            yield return
                string.Format("\tpublic final ListProperty<String> {0} = listProperty(\"{0}\");",
