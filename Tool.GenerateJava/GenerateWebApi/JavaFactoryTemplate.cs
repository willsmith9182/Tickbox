...
namespace Tool.GenerateJava.GenerateWebApi
{
    ...
    /// </summary>
#line 1 "D:\Lat Projects\WL_Main\Tool.GenerateJava\GenerateWebApi\JavaFactoryTemplate.tt"
    [GeneratedCode("Microsoft.VisualStudio.TextTemplating", "12.0.0.0")]
    public partial class JavaFactoryTemplate : JavaFactoryTemplateBase
    {
        /// <summary>
        ...
        /// </summary>
        private List<ClassNamePair> classNames { get; set; }
...
#line 13 "D:\Lat Projects\WL_Main\Tool.GenerateJava\GenerateWebApi\JavaFactoryTemplate.tt"
...
#line 18 "D:\Lat Projects\WL_Main\Tool.GenerateJava\GenerateWebApi\JavaFactoryTemplate.tt"

            foreach (var name in classNames)
            {
#line default
#line hidden
                Write("public static I");

#line 20 "D:\Lat Projects\WL_Main\Tool.GenerateJava\GenerateWebApi\JavaFactoryTemplate.tt"
                Write(ToStringHelper.ToStringWithCulture(name.PascalCaseName));
...
#line 20 "D:\Lat Projects\WL_Main\Tool.GenerateJava\GenerateWebApi\JavaFactoryTemplate.tt"
                Write(ToStringHelper.ToStringWithCulture(name.CamelCaseName));
...
#line 21 "D:\Lat Projects\WL_Main\Tool.GenerateJava\GenerateWebApi\JavaFactoryTemplate.tt"
            }
...
#line hidden
        ...
        public virtual void Initialize()
        {
            if ((Errors.HasErrors == false))
            {
                ...
                {
                    classNames = ((List<ClassNamePair>) (Session["classNames"]));
                ...
                if ((classNamesValueAcquired == false))
                {
                    ...
                    if ((data != null))
                    {
                        classNames = ((List<ClassNamePair>) (data));
                    }
                }
            }
        }
...
#line hidden
    ...
    /// </summary>
    [GeneratedCode("Microsoft.VisualStudio.TextTemplating", "12.0.0.0")]
    public class JavaFactoryTemplateBase
    {
        #region Fields
