...
namespace TickBox.Objects
{
    ...
    public partial class Taxonomy : IEquatable<Taxonomy>, IKeyComparable<Taxonomy>, IScaffold, IEntity
    {
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                ...
                hashCode = (hashCode * 397) ^ this.TemplateId;
        ...
        /// The <see cref="bool"/>.
        /// </returns>
        public bool KeysMatch(Taxonomy other)
        {
            if (ReferenceEquals(null, other))
            {
                return false;
