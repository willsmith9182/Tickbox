...
{
    internal class TaxonomyScaffold : ScaffoldDefinition<Taxonomy>
    {
        ...
        {
            var referenceTemplate = contextLocator.Get<TickboxDatabaseEntities>()
                .Template.Single(t => t.TemplateId == 1);
