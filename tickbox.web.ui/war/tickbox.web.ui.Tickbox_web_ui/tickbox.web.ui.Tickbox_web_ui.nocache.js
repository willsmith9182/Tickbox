...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "tickbox.web.ui.Tickbox_web_ui" because\n';
  ...
  $wnd.__gwt_activeModules['tickbox.web.ui.Tickbox_web_ui'] = {
    'moduleName' : 'tickbox.web.ui.Tickbox_web_ui',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/tickbox.web.ui.Tickbox_web_ui.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['tickbox.web.ui.Tickbox_web_ui'].superdevmode = true;

  var expectedSuffix = '/tickbox.web.ui.Tickbox_web_ui.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + tickbox.web.ui.Tickbox_web_ui + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:tickbox.web.ui.Tickbox_web_ui';
  var devModeSessionKey = '__gwtDevModeSession:tickbox.web.ui.Tickbox_web_ui';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/tickbox.web.ui.Tickbox_web_ui/tickbox.web.ui.Tickbox_web_ui.nocache.js';
  ...
  $wnd.__gwt_activeModules['tickbox.web.ui.Tickbox_web_ui'].canRedirect = true;
  $wnd.__gwt_activeModules['tickbox.web.ui.Tickbox_web_ui'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING tickbox.web.ui.Tickbox_web_ui';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/tickbox.web.ui.Tickbox_web_ui?user.agent=' + ua + '&_callback=' + callback;
