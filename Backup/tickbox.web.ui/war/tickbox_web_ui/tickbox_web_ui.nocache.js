...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "tickbox_web_ui" because\n';
  ...
  $wnd.__gwt_activeModules['tickbox_web_ui'] = {
    'moduleName' : 'tickbox_web_ui',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/tickbox_web_ui.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['tickbox_web_ui'].superdevmode = true;

  var expectedSuffix = '/tickbox_web_ui.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + tickbox_web_ui + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:tickbox_web_ui';
  var devModeSessionKey = '__gwtDevModeSession:tickbox_web_ui';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/tickbox_web_ui/tickbox_web_ui.nocache.js';
  ...
  $wnd.__gwt_activeModules['tickbox_web_ui'].canRedirect = true;
  $wnd.__gwt_activeModules['tickbox_web_ui'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING tickbox_web_ui';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/tickbox_web_ui?user.agent=' + ua + '&_callback=' + callback;
